...
<style>
:root{--ink:#213737;--muted:#7b8986;--bg:#f7f8f3;--surface:#fffefa;--line:#e7ebe3;--accent:#8aa68c;--accent-dark:#587a61;--soft:#edf3e9;--warm:#f1e6d5;--shadow:0 18px 50px rgba(60,82,65,.08);--radius:20px}
